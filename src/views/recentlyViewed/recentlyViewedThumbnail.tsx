...
import { cutOffText, secondsToHms, secondsToHHMMSS } from '../../utility/utility'
...
class VideoThumbnail extends React.Component<VideoThumbnailProps, VideoThumbnailState> {
  render() {
    const { title, description, source, created_at, username, count, rand, updated_at, duration } = this.props
      ...
      <div className="recently-viewed-thumbnail">
        ...
        <div className="recently-viewed-thumbnail-info">
          ...
          <div className="recently-viewed-thumbnail-info-text">
            ...
            <span className="recently-viewed-thumbnail-info-text-user">{username}</span>
            <br />
            <span className="recently-viewed-thumbnail-info-text-views">{count} Views</span> |{' '}
            <span className="video-thumbnail-info-text-time">{`${createdTimeAgo} ago`}</span>
